...
#+begin_src emacs-lisp
  ...
  (use-package use-package-ensure-guix
    ...
    (use-package-ensure-guix-profile "/home/juanpablo/.guix-home/profile")
    )
...
#+begin_src emacs-lisp
    ...
    (defun load-all-gptel-modules ()
      "Find and require all gptel-* modules."
      (interactive)
      (let* ((gptel-dir (file-name-directory (locate-library "gptel")))
             (gptel-files (directory-files gptel-dir t "^gptel-.*\\.el$")))
        (dolist (file gptel-files)
