...
#+begin_src emacs-lisp
  ...
  ;; Defer project scanning to idle time
  (run-with-idle-timer 3 nil
    (lambda ()
      (when (file-directory-p "~/work/repos")
        (project-remember-projects-under "~/work/repos" t))))
#+end_src
** Templates
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
    ...
    ;; Alternatively, if you want to place it in a specific section, you can use something like:
    ;; (transient-append-suffix 'gptel-menu '("SPC") 
    ;;   '("j" "Jump to gptel buffer" gptel--suffix-jump-to-gptel-buffer))
    ...
    ;; (setq wingman-model-name "llama3:latest")
  ...
  (use-package claude-code-ide
    ...
    ;;   (setenv "ANTHROPIC_API_KEY;; " (get-authinfo-password "anthropic.com"))
    ...
    ;;   :custom
    ;;   (copilot-node-executable "/home/juanpablo/.guix-home/profile/bin/node")
    ...
    ;;   :config
    ;;   (add-to-list 'exec-path "/home/juanpablo/.npm-global/bin")
    ;;   (setq claude-code-program (executable-find "claude"))
    ;;   )
